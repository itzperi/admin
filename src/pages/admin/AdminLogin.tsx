...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary/95 to-primary/90 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        <div className="bg-card rounded-2xl shadow-2xl p-8 animate-slide-up">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 gradient-gold rounded-2xl flex items-center justify-center shadow-gold">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-muted-foreground">
              Secure Admin Access • Gold & Silver Scheme Management
            </p>
          </div>
        </div>
      </div>
